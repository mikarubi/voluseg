...
Voluseg validates parameters with sensible defaults that can be overridden to fit your specific needs. You can read more about the parameters in the [Parameters](parameters.qmd) section. Define and save the parameters by running:
