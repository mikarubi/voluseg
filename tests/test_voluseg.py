...
# def manage_usercustomize_py():
#     from .coverage_utils import create_usercustomize_py, remove_usercustomize_py

#     # Setup: Create a usercustomize.py file to enable coverage for subprocesses
#     file_path = "/mnt/shared_storage/Github/voluseg/tests/usercustomize.py"
#     create_usercustomize_py(file_path)

#     yield  # This is where the testing happens

#     # Teardown: Remove the usercustomize.py file after all tests
#     # remove_usercustomize_py(file_path)
