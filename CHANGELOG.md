...
### Changed
- Documentation moved from Docusaurus to Quarto: pages are plain markdown,
  the API reference is generated by quartodoc (native NumPy-docstring
  support, retiring the pydoc-markdown fork), and the ~1,000-package npm
  dependency tree - the source of GitHub's vulnerability alerts - is gone.
